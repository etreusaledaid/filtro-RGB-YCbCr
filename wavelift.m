...
% 
% Reference:
%   [1] D.S.Taubman and M.W. Marcellin, 
%       JPEG2000 Image Compression: Fundamentals, Standards and Practice
%       Edition 2002, sections 6.4, 6.5, 10.3 and 10.4
%   [2] ISO/IEC FCD1544-1:2000 (V1.0, 16 March 2000), 
%       Coding of Still Pictures, JPEG200 Part 1 Final Committe Draft
%   [3] D. Salomon,
%       Data Compression: The complete Reference 
%       Fourth Edition (2007), sections 5.11 and 5.19
%
% Cantact information: 
%   Email/MSN messenger: wangthth@hotmail.com
%                        jmoreno@cvc.uab.es    
%
% Tianhui Wang at Beijing, China,   Aug 6, 2006
% Jaime Moreno at Barcelona, Spain, Jun 10, 2009
%                   Last Revision:  Jun 11, 2009
...
switch wname
    case 'cdf97'
        %[1] 6.4.1 (Example 6.6 page 285)
        %[2] F.2.8.2 (Equation F.6 page 119)
        %[3] 5.19 (JPEG 2000 Page 645)
        lamdaz=struct('coeff',{[-1.5861343420693648,-1.5861343420693648],... %alfa
                              [-0.0529801185718856,-0.0529801185718856],... %beta
                              [ 0.8829110755411875, 0.8829110755411875],... %gamma
                              [ 0.4435068520511142,0.4435068520511142]},... %delta
                   'zorder', {[0 1], [0 -1], [0 1], [0 -1]});
       L=struct('lamdaz',lamdaz,'K',[1/1.230174104914, 1.230174104914/2]);
       mode='lossy';
    case 'spl53'
        %[1] 6.4.1 (Example 6.5 page 283)
        %[2] F.2.8.1 (Equations F.3 y F.4 page 118)
        %[3] 5.19 (JPEG 2000 Page 645)
